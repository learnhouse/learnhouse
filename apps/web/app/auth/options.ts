...
export const nextAuthOptions = (cookies?: any) => {
  // Config Cookies to domain 
  let customDomain = cookies ? cookies.get('learnhouseCustomDomainForAuth')?.value : null
  let cookiesDomain = customDomain ? customDomain : `.${LEARNHOUSE_TOP_DOMAIN}`
