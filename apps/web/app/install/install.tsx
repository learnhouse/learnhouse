...
const Stepscomp = () => {
  ...
  const [stepsState, setStepsState] = useState(INSTALL_STEPS)
  ...
  return (
    <div>
      <div className="flex justify-center">
        ...
        <div className="steps m-auto flex w-fit justify-center space-x-2 rounded-full bg-slate-50 p-3 px-10 text-sm">
          <div className="flex space-x-8">
            {stepsState.map((step, index) => (
              ...
              >
                <div
                  className={`m-auto flex h-7 w-7 items-center justify-center rounded-full bg-slate-200 align-middle text-slate-700 transition-all hover:bg-slate-300 ${
      ...
      <div className="flex flex-col pt-8">
        <h1 className="text-3xl font-bold">{stepsState[stepNumber].name}</h1>
