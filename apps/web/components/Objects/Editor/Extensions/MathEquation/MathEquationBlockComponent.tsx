                  ...
                  {showHelp && (
                    <HelpDropdown className="absolute left-0 mt-1 z-10 w-72">
                      ...
                      <div className="p-3 text-xs space-y-2">
                        ...
                        <div>
                          <span className="font-medium">Exponents:</span> x^
                          {'{'}'power'{'}'}
                        </div>
                        <div>
                          <span className="font-medium">Subscripts:</span> x_
                          {'{'}'subscript'{'}'}
                        </div>
                        <div>
                          <span className="font-medium">Square root:</span>{' '}
                          \sqrt{'{'}'x'{'}'}
                        </div>
                        <div>
                          <span className="font-medium">Summation:</span> \sum_
                          {'{'}'lower'{'}'}^{'{'}'upper'{'}'}
                        </div>
                        <div>
