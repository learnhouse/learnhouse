...
# Query execution/authorization primitives extracted to the analytics runner
# (shared with the agent tools). Underscore aliases keep handler call sites
# and existing test patch targets unchanged.
from src.services.analytics.runner import (
    _get_read_client,
    build_sql as _build_sql,
    enrich_with_metadata as _enrich_with_metadata,
    execute_tinybird_query as _execute_tinybird_query,
    validate_course_uuid as _validate_course_uuid,
    verify_org_admin as _verify_org_admin,
    verify_org_membership as _verify_org_membership,
)

__all__ = ["router", "_get_read_client"]  # _get_read_client re-exported for tests
