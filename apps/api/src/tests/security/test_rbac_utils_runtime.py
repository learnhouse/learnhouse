...
class TestRBACUtilsRuntime:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("course_1", [SimpleNamespace(org_id=11)], 11),
            ("course_2", [None], None),
            ("chapter_1", [SimpleNamespace(course_id=5), SimpleNamespace(org_id=12)], 12),
            ("chapter_2", [None], None),
            ("chapter_3", [SimpleNamespace(course_id=5), None], None),
            ("activity_1", [SimpleNamespace(course_id=6), SimpleNamespace(org_id=13)], 13),
            ("activity_2", [None], None),
            ("activity_3", [SimpleNamespace(course_id=6), None], None),
            ("collection_1", [SimpleNamespace(org_id=14)], 14),
            ("collection_2", [None], None),
            ("org_1", [SimpleNamespace(id=15)], 15),
            ("org_2", [None], None),
            ("role_1", [SimpleNamespace(org_id=16)], 16),
            ("role_2", [None], None),
            ("usergroup_1", [SimpleNamespace(org_id=17)], 17),
            ("usergroup_2", [None], None),
            ("user_1", [], None),
            ("house_1", [], None),
            ("community_1", [SimpleNamespace(org_id=18)], 18),
            ("community_2", [None], None),
            ("discussion_1", [SimpleNamespace(org_id=19)], 19),
            ("discussion_2", [None], None),
            ("vote_1", [SimpleNamespace(discussion_id=20), SimpleNamespace(org_id=21)], 21),
            ("vote_2", [None], None),
            ("vote_3", [SimpleNamespace(discussion_id=20), None], None),
            ("podcast_1", [SimpleNamespace(org_id=22)], 22),
            ("podcast_2", [None], None),
            ("episode_1", [SimpleNamespace(podcast_id=30), SimpleNamespace(org_id=23)], 23),
            ("episode_2", [None], None),
            ("episode_3", [SimpleNamespace(podcast_id=30), None], None),
            ("board_1", [SimpleNamespace(org_id=24)], 24),
            ("board_2", [None], None),
        ],
    )
